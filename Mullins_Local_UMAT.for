...
****************************************************************************
      ...
      !
      subroutine integ(props,nprops,flag,
     +     F_tau,dtime,timeflag,theta_t,
     +     T_tau,LambdaBar_t,LambdaBar_tau,theta_tau,
     +     nu_t,nu_tau,Achainmax)
      !
     ...
     +     third=1.d0/3.d0)
      ...
      !
      if (flag.eq.one) then
      call solvenu(nu_tau,args,nargs)
...
****************************************************************************
      ! This is a utility subroutine for numerically solving for the ``local'' soft volume fraction
